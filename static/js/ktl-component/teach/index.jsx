      ...
      <section className="ktl-container ktl-offset-top-xl">
        ...
        <div className="teach-top-mobile-buttons">
          ...
          <Button mode="outline"
                  ...
                  className="teach-cta-block-button">为什么讲授 Kotlin&nbsp;→</Button>
        </div>
        ...
        <div className="teach-features ktl-row">
          ...
          <div className="ktl-col-12 ktl-col-md-4">
            <div className="teach-feature">
              ...
              <div className="teach-feature__content">
                <div className="ktl-h3 ktl-offset-bottom-s">学术认可</div>
      ...
      <section className="teach-resources ktl-offset-top-xxl ktl-with-anchor" id="start-teaching-kotlin">
        <div className="ktl-container">
          ...
          <ul className="teach-links">
            ...
            <li>
              <p className="ktl-h4 ktl-offset-bottom-xs">Kotlin Android 开发</p>
              <ul className="teach-list">
                <li className="teach-list__item">
                  <a
                    href="/docs/android-overview.html" target="_blank">
                    <span className="rs-link">文档</span>
                  </a>
                </li>
                <li className="teach-list__item">
                  <div className="ktl-text-2 ktl-dimmed-text">由 Google 的 Android 开发人员关系团队<!--
                    -->推荐：
                  </div>
                  <ul className="teach-list teach-sublist">
                    <li className="teach-list__item">
