...
The Kotlin team continues to stabilize the K2 compiler. As mentioned in the [Kotlin 1.7.0 announcement](whatsnew17.md#用于-jvm-的新版-kotlin-k2-编译器进入-alpha-阶段),
...
Starting with the 1.8.20-Beta preview release, you can use Kotlin/Wasm in your experimental projects.
...
some of them starting with Kotlin 1.8.20-Beta. See the [Kotlin/Native target support](native-target-support.md) section
for the full list of supported and deprecated targets.
...
The following targets have been deprecated with Kotlin 1.8.20-Beta and will be removed in 1.9.20:
...
Kotlin 1.8.20-Beta contains a preview of the improved support that should work with a larger variety of projects.
...
Starting with Kotlin 1.8.20-Beta, Xcode can parse the output from the Kotlin/Native compiler. Furthermore, in case the
