...
With [the new hierarchical project structure support](multiplatform-share-on-platforms.md#对相似平台共享代码), 
...
Instead of doing this, you can create a hierarchical structure with [target shortcuts](multiplatform-share-on-platforms.md#使用目标快捷方式) 
