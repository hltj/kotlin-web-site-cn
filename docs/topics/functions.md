...
either as a named argument or [outside the parentheses](lambdas.md#passing-a-lambda-to-the-last-parameter):
...
>
> See the [Grammar reference](grammar.md#expressions) for the complete operators precedence hierarchy.
{:.note}
