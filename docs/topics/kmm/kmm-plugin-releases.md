...
* Support for [Kotlin 1.5.20](whats-new-in-kotlin-for-kmm.md#kotlin-1-5-20-用于-kmm): using the new framework-packing task for Kotlin/Native in the Project Wizard.
