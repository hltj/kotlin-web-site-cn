...
See [compilation configurations](mpp-configure-compilations.md#配置与原生语言的互操作) for more details.
...
framework ([see here for how to declare binaries](mpp-build-native-binaries.md#声明二进制文件)).
