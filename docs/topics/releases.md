...
new features before they are released. See [Early Access Preview](eap/index.md) for details.

Learn more about [types of Kotlin releases and their compatiblity](docs/reference/evolution/kotlin-evolution.md#feature-releases-and-incremental-releases).
...
You can also use [preview versions of Kotlin](eap/index.md#build-details).
