...
<table>
    ...
    <tr>
        <td><strong>1.6.0-RC2</strong>
            <p>Released: <strong>November 3, 2021</strong></p>
            <p><a href="https://github.com/JetBrains/kotlin/releases/tag/v1.6.0-RC2" target="_blank">Release on GitHub</a></p>
        </td>
        <td>
             <ul>
                <li>Stabilization of new features from 1.6.0-M1 and 1.6.0-RC</li>
            </ul>
            <p>For more details, please refer to the <a href="https://github.com/JetBrains/kotlin/releases/tag/v1.6.0-RC2">changelog</a>.</p>
        </td>
        <td>
            <ul>
